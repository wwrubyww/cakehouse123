...
<div id="top">
       <div class="container">
           <div class="col-md-6 offer" data-animate="fadeInDown">
               <a href="web/register.php" class="btn btn-success btn-sm" data-animate-hover="shake">前往加入會員</a>  <a href="#">立即取得200元購物金!</a>
           </div>
           <div class="col-md-6" data-animate="fadeInDown">
            ...
            <?php }else{ ?>
                   <li><a href="#" data-toggle="modal" data-target="#login-modal"><?php echo $_SESSION['member']['name_date'];?> 您好!</a>
                   </li>
                   <li><a href="web/logout_success.php">登出</a>
                   </li>
            <?php } ?>
       ...
       <div class="container">
           ...
           <div class="navbar-buttons">
               ...
               <div class="navbar-collapse collapse right" id="basket-overview">
                   <a href="web/basket.php" class="btn btn-primary navbar-btn"><i class="fa fa-shopping-cart"></i><span class="hidden-sm">(0)</span></a>
               </div>
               <!--/.nav-collapse -->
