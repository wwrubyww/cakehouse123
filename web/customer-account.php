...
if(isset($_POST['EditForm']) && $_POST['EditForm'] == "UPDATE"){
    $sql= "UPDATE members SET   name_date=:name_date, phone=:phone, email=:email, address=:address, birthday=:birthday, zipcode=:zipcode, mobile=:mobile, updated_at=:updated_at WHERE memberID=:memberID";
