            ...
            <div class="container">
                ...
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li> <a href="product_list.php?categoryID=<?php echo $category['product_categoryID']; ?>"><?php echo $category['category']; ?></a>
                        </li>
                    </ul>
                        ...
                        <div class="col-sm-6">
                            <form action="cart/add_cart1.php" method="post">
                                <div class="box">
                                    ...
                                    <p class="goToDescription"><a href="#details" class="scroll-to"><?php echo $products['description']; ?></a>
                                    </p>
