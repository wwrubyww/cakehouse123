                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name"  vaule="<?php echo $_SESSION['member']['name']; ?>"
                                            >
                                        </div>
                                    </div>
                                    <div class="col-sm-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" name="phone"  vaule="<?php echo $_SESSION['member']['mobile']; ?>" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4 ">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email"  vaule="<?php echo $_SESSION['member']['email']; ?>">
                                        </div>
                                    </div>
